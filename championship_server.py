...
def _frontend_root():
    ...
    for asset in ("urbion_championship_spatial_studio.js","urbion_championship_decision_layer.js"):
...
app.state.frontend_release="MASTER-300"
