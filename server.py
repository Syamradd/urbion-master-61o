...
app=FastAPI(title='URBION API',version='MASTER-76');app.add_middleware(CORSMiddleware,allow_origins=['*'],allow_credentials=False,allow_methods=['*'],allow_headers=['*'])
