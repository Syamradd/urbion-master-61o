...
ALLOWED_ASSETS = frozenset(
    {
        ...
        "urbion_championship_dashboard.js", "urbion_championship_polish.js", "urbion_championship_v279.js",
        "urbion_public_source_ui.js", "urbion_public_spatial_v283.js", "urbion_public_spatial_v284.js",
        "urbion_championship_spatial_studio.js", "urbion_championship_decision_layer.js",
...
for _asset in ALLOWED_ASSETS:
    _path = f"/{_asset}"
    app.add_api_route(_path, lambda asset=_asset: _asset_response(asset), methods=["GET"], include_in_schema=False)
