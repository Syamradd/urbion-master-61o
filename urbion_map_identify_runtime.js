...
function renderSelected(){
  ...
  panel.querySelector('[data-umi-evidence]').onclick=()=>{state.last=evidenceHandoff(payload);window.dispatchEvent(new CustomEvent('urbion-map-evidence',{detail:state.last}));};
