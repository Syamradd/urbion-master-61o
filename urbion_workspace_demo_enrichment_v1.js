...
const hydrate=()=>{for(const [id,v] of Object.entries(values))set(id,v);document.getElementById('shop_frontage_verified')?.click();document.getElementById('shop_office_verified')?.click();return true};
