...
SOURCE_CATALOG = [
    {"id":"iplan","name":"PLANMalaysia i-Plan","agency":"PLANMalaysia","category":"PLANNING","status":"LIVE_ARCGIS_REST","role":"Current land use, zoning, committed land use, cadastral context and planning layers","url":"https://iplan.planmalaysia.gov.my/","acquisition":"Public geoportal; data request module is available through i-Plan."},
...
def map_layer_catalog(state: str = "Melaka") -> list[dict]:
    ...
    return [
        ...
        {"id":"iplan-committed","name":"i-Plan · Committed Land Use","name_ms":"i-Plan · Guna Tanah Komited","group":"PLANNING","type":"PORTAL_REFERENCE","source":"iplan","evidence":"SOURCE_CONTEXT","access_note":"Use the official i-Plan interactive geoportal/data-request route; no unverified GTkomited_<state> MapServer is asserted."},
