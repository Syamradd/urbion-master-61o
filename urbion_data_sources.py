...
SOURCE_CATALOG = [
    {"id":"iplan","name":"PLANMalaysia i-Plan","agency":"PLANMalaysia","category":"PLANNING","status":"LIVE_ARCGIS_REST","role":"Current land use, zoning, committed land use, cadastral context and planning layers","url":"https://iplan.planmalaysia.gov.my/"},
...
def map_layer_catalog(state: str = "Melaka") -> list[dict]:
    ...
    return [
        ...
        {"id":"iplan-committed","name":"i-Plan · Committed Land Use","name_ms":"i-Plan · Guna Tanah Komited","group":"PLANNING","type":"ARCGIS_QUERY","service":f"GTkomited_{code}" if code else None,"source":"iplan","evidence":"SOURCE_CONTEXT"},
