...
def _iplan_wms(layer: str, name: str, name_ms: str, group: str = "PLANNING") -> dict:
    return {"id":f"iplan-{layer}","name":f"i-Plan · {name}","name_ms":f"i-Plan · {name_ms}","group":group,"type":"GEOSERVER_WMS","url":"https://iplan.planmalaysia.gov.my/geoserver/iplan/wms","layers":f"iplan:{layer}","source":"iplan","evidence":"SOURCE_CONTEXT"}
...
def map_layer_catalog(state: str = "Melaka") -> list[dict]:
    ...
    layers = [
        ...
        {"id":"mygems-faults","name":"MyGEMS · Major Faults","name_ms":"MyGEMS · Sesar Utama","group":"GEOLOGY","type":"ARCGIS_MAP","url":"https://mygems.jmg.gov.my/server/rest/services/GeologiAsas/Major_Fault/MapServer","source":"jmg-mygems","evidence":"SOURCE_CONTEXT","layerId":5},
        ...
        {"id":"mygems-geophysics","name":"MyGEMS · Geophysics","name_ms":"MyGEMS · Geofizik","group":"GEOLOGY","type":"ARCGIS_MAP","url":"https://mygems.jmg.gov.my/server/rest/services/GeoFizik/Geofizik_Awam/MapServer","source":"jmg-mygems","evidence":"SOURCE_CONTEXT"},
        {"id":"iplan-river","name":"i-Plan / DPFDN · River & Drainage","name_ms":"i-Plan / DPFDN · Sungai & Saliran","group":"HYDROLOGY","type":"INFO_SCREENING","url":"https://scharms.planmalaysia.gov.my/arcgis/rest/services/DPFDN/AlamSekitar/MapServer","source":"iplan","evidence":"SOURCE_CONTEXT","layer_id":3,"access_note":"Source-backed river/drainage screening is available to the environmental connector; visual geometry may depend on the public service response."},
        {"id":"iplan-catchment","name":"i-Plan / DPFDN · Catchment","name_ms":"i-Plan / DPFDN · Kawasan Tadahan","group":"HYDROLOGY","type":"INFO_SCREENING","url":"https://scharms.planmalaysia.gov.my/arcgis/rest/services/DPFDN/AlamSekitar/MapServer","source":"iplan","evidence":"SOURCE_CONTEXT","layer_id":4,"access_note":"Source-backed catchment screening; portal/service availability governs visual rendering."},
        {"id":"iplan-protected-area","name":"i-Plan / DPFDN · Protected Area","name_ms":"i-Plan / DPFDN · Kawasan Perlindungan","group":"ENVIRONMENT","type":"INFO_SCREENING","url":"https://scharms.planmalaysia.gov.my/arcgis/rest/services/DPFDN/AlamSekitar/MapServer","source":"iplan","evidence":"SOURCE_CONTEXT","layer_id":1},
        {"id":"iplan-slope","name":"i-Plan / DPFDN · Slope","name_ms":"i-Plan / DPFDN · Kecerunan","group":"TERRAIN","type":"INFO_SCREENING","url":"https://scharms.planmalaysia.gov.my/arcgis/rest/services/DPFDN/Bencana/MapServer","source":"iplan","evidence":"SOURCE_CONTEXT","layer_id":3},
        {"id":"iplan-landslide","name":"i-Plan / DPFDN · Landslide","name_ms":"i-Plan / DPFDN · Tanah Runtuh","group":"GEOHAZARD","type":"INFO_SCREENING","url":"https://scharms.planmalaysia.gov.my/arcgis/rest/services/DPFDN/Bencana/MapServer","source":"iplan","evidence":"SOURCE_CONTEXT","layer_id":1},
        {"id":"iplan-fault","name":"i-Plan / DPFDN · Fault","name_ms":"i-Plan / DPFDN · Garis Sesar","group":"GEOHAZARD","type":"INFO_SCREENING","url":"https://scharms.planmalaysia.gov.my/arcgis/rest/services/DPFDN/Bencana/MapServer","source":"iplan","evidence":"SOURCE_CONTEXT","layer_id":0},
    ]
    return layers
