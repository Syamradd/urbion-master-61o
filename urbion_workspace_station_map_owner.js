...
function loadJudgeOwner(){if(window.__URBION_JUDGE_OWNER_V1__)return;const s=document.createElement('script');s.src='/urbion_workspace_judge_owner_v1.js';s.async=false;s.onload=()=>window.dispatchEvent(new CustomEvent('urbion:judge-owner-ready'));s.onerror=()=>console.warn('URBION P1 judge owner unavailable');document.body.appendChild(s)}
function boot(){loadJudgeOwner();let n=0;const t=setInterval(()=>{if(mount()||++n>=300)clearInterval(t)},100)}
