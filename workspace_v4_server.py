...
def demo_enrichment_asset():
 if not _DEMO_ENRICHMENT_ASSET.is_file():return Response("URBION HORIZON demo enrichment layer missing.",status_code=500,media_type="text/plain; charset=utf-8")
