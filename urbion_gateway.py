...
class ChampionshipOverlayMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request, call_next):
        ...
        if marker in body and b"MASTER-270" not in body:
            body = body.replace(marker, _CHAMPIONSHIP_OVERLAY.encode("utf-8") + b'<script src="/urbion_championship_dashboard.js"></script><script src="/urbion_championship_polish.js"></script><script src="/urbion_championship_v277.js"></script>' + marker, 1)
