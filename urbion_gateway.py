...
def environment_intelligence(payload: dict = Body(default_factory=dict)):
    """Run explicit environmental/geohazard screening without inventing missing evidence."""
    return build_environment_intelligence(payload.get("environment_context") or payload.get("context") or payload)
