"""Isolated Render entrypoint for the canonical URBION HORIZON Workspace V2 preview."""
from pathlib import Path

from fastapi import FastAPI, HTTPException
from fastapi.responses import HTMLResponse

# Import the proven backend and registration modules without touching the existing production entrypoint.
...
@app.get("/workspace-v2.html", include_in_schema=False)
