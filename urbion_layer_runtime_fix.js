...
async function refresh(){const m=getMap();if(!m||typeof L==='undefined'||!$('layerList'))return false;try{draw(await catalog());return true}catch(e){$('layerList').innerHTML=`<div class="tiny" style="color:var(--bad)">Live catalogue error · ${String(e.message||e)}</div>`;return false}}
