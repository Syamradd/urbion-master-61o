...
def _fallback(packet: dict) -> str:
    ...
    return (
        f"URBION HORIZON screens this proposal as {status}{score_text}. "
...
def _prompt(packet: dict) -> str:
    ...
    return (
        "You are the narrative layer of URBION HORIZON, a planning decision-support system. "
...
def generate_planner_explanation(packet: dict, timeout: float = 12.0) -> dict:
    ...
    payload = {
        "contents": [{"parts": [{"text": _prompt(packet)}]}],
